...
def user():
    ...
    if form.validate_on_submit():
        ...
        if not os.path.exists(config.BaseConfig.FC_DIR):
            os.makedirs(config.BaseConfig.FC_DIR)
            os.chmod(config.BaseConfig.FC_DIR, "rw")
        user.face = change_filename(file_face)
        form.face.data.save(config.BaseConfig.FC_DIR + user.face)
